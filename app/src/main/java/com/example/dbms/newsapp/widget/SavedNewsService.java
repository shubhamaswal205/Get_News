package com.example.dbms.newsapp.widget;
...
public class SavedNewsService extends IntentService {
    ...
    public static final String ACTION_GET_NEXT = "com.example.dbms.newsapp.widget.action.saved.next";
    public static final String ACTION_GET_PREVIOUS = "com.example.dbms.newsapp.widget.action.saved.previous";
    private static final String ACTION_UPDATE_WIDGETS = "com.example.dbms.newsapp.widget.action.update_widgets";

    public static final String PARAM_CURRENT = "com.example.dbms.newsapp.widget.extra.current_selected";
